...
train_path = './lateblight/train/'
test_path = './lateblight/test/'
classes = ["lateblight", "non_lateblight"]
...
open('./lateblight/weight/'+str(epoch)+'/lateblight.json','w').write(json_string)
model.save_weights('./lateblight/weight/'+str(epoch)+'/lateblight.h5')
print('model save')