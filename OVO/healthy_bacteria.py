...
train_path = './healthy_bacteria/train/'
test_path = './healthy_bacteria/test/'
classes = ["bacteria", "healthy"]
...
open('./healthy_bacteria/weight/'+str(epoch)+'/healthy_bacteria.json','w').write(json_string)
model.save_weights('./healthy_bacteria/weight/'+str(epoch)+'/healthy_bacteria.h5')
print('model save')