...
train_path = './bacteria_lateblight/train/'
test_path = './bacteria_lateblight/test/'
classes = ["bacteria", "lateblight"]
...
open('./bacteria_lateblight/weight/'+str(epoch)+'/bacteria_lateblight.json','w').write(json_string)
model.save_weights('./bacteria_lateblight/weight/'+str(epoch)+'/bacteria_lateblight.h5')
print('model save')