...
train_path = './healthy_targetspot/train/'
test_path = './healthy_targetspot/test/'
classes = ["targetspot", "healthy"]
...
open('./healthy_targetspot/weight/'+str(epoch)+'/healthy_targetspot.json','w').write(json_string)
model.save_weights('./healthy_targetspot/weight/'+str(epoch)+'/healthy_targetspot.h5')
print('model save')