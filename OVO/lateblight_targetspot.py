...
train_path = './lateblight_targetspot/train/'
test_path = './lateblight_targetspot/test/'
classes = ["lateblight", "targetspot"]
...
plt.xlabel('epoch')
plt.title('lateblight_targetspot')
...
open('./lateblight_targetspot/weight/'+str(epoch)+'/lateblight_targetspot.json','w').write(json_string)
model.save_weights('./lateblight_targetspot/weight/'+str(epoch)+'/lateblight_targetspot.h5')
print('model save')