...
train_path = './bacteria_yellowleafcurl/train/'
test_path = './bacteria_yellowleafcurl/test/'
classes = ["bacteria", "yellowleafcurl"]
...
plt.xlabel('epoch')
plt.title('bacteria_yellowleafcurl')
...
open('./bacteria_yellowleafcurl/weight/'+str(epoch)+'/bacteria_yellowleafcurl.json','w').write(json_string)
model.save_weights('./bacteria_yellowleafcurl/weight/'+str(epoch)+'/bacteria_yellowleafcurl.h5')
print('model save')