...
train_path = './targetspot_yellowleafcurl/train/'
test_path = './targetspot_yellowleafcurl/test/'
classes = ["targetspot", "yellowleafcurl"]
...
plt.xlabel('epoch')
plt.title('targetspot_yellowleafcurl')
...
open('./targetspot_yellowleafcurl/weight/'+str(epoch)+'/targetspot_yellowleafcurl.json','w').write(json_string)
model.save_weights('./targetspot_yellowleafcurl/weight/'+str(epoch)+'/targetspot_yellowleafcurl.h5')
print('model save')