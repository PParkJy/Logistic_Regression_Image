...
train_path = './bacteria_targetspot/train/'
test_path = './bacteria_targetspot/test/'
classes = ["bacteria", "targetspot"]
...
open('./bacteria_targetspot/weight/'+str(epoch)+'/bacteria_targetspot.json','w').write(json_string)
model.save_weights('./bacteria_targetspot/weight/'+str(epoch)+'/bacteria_targetspot.h5')
print('model save')