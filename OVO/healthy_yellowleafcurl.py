...
train_path = './healthy_yellowleafcurl/train/'
test_path = './healthy_yellowleafcurl/test/'
classes = ["yellowleafcurl", "healthy"]
...
plt.xlabel('epoch')
plt.title('healthy_yellowleafcurl')
...
open('./healthy_yellowleafcurl/weight/'+str(epoch)+'/healthy_yellowleafcurl.json','w').write(json_string)
model.save_weights('./healthy_yellowleafcurl/weight/'+str(epoch)+'/healthy_yellowleafcurl.h5')
print('model save')