...
train_path = './healthy_lateblight/train/'
test_path = './healthy_lateblight/test/'
classes = ["lateblight", "healthy"]
...
open('./healthy_lateblight/weight/'+str(epoch)+'/healthy_lateblight.json','w').write(json_string)
model.save_weights('./healthy_lateblight/weight/'+str(epoch)+'/healthy_lateblight.h5')
print('model save')