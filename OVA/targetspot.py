...
train_path = './targetspot/train/'
test_path = './targetspot/test/'
classes = ["targetspot", "non_targetspot"]
...
open('./targetspot/weight/'+str(epoch)+'/targetspot.json','w').write(json_string)
model.save_weights('./targetspot/weight/'+str(epoch)+'/targetspot.h5')
print('model save')